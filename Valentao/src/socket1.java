...
public class socket1 extends Thread {
            ...
            public void run() {
                try {
                    ...
                    while (true) {
                        ...
                        socket1 server = new socket1(connectionSocket);
                        server.start();
                    }
            ...
            while ( (line = inFromClient.readLine()) != null ) {
                ...
                if ( messageType.equals(eleicaoMessage) ) {
                    ...
                    if(Integer.parseInt(message_id) < Integer.parseInt(pid) && message_id == "1"){
                        ...
                        //String message_id;
                        String message;
                        message = "COORDENADOR" + "@" + pid + "@" + timestamp.toString() + "@" + message_id;
                        /* Incremento do timestamp. */
                        timestamp.incrementAndGet();
                        outToProcessA.write(message);
                        outToProcessA.newLine();
