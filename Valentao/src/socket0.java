            ...
            public void run() {
                try {
                    ...
                    while (true) {
                        ...
                        socket0 server = new socket0(connectionSocket);
                        server.start();
                    }
            ...
            while ( (line = inFromClient.readLine()) != null ) {
                ...
                if ( messageType.equals(eleicaoMessage) ) {
                    ...
                    if(Integer.parseInt(message_id) < Integer.parseInt(pid) && message_id == "2"){
                        ...
                        if(Integer.parseInt(message_id) < Integer.parseInt(pid) && message_id == "3"){
...
//            e.printStackTrace();
            ...
            Logger.getLogger(socket0.class.getName()).log(Level.SEVERE, null, ex);
        }
